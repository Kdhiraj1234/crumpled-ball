...
if(keyCode === RIGHT_ARROW){
 ...
 //maam i have created a class and also tried to code it to make a paperball using the class but it does not 
 //show anything on 200 ok server if i use the class,thats why i made a sprite instead.
 //and even i did not delete the class to show you that i made.
 //maam if the ball touches the bin it stops.
